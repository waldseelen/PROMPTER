export const i18n = {
    tr: {
        ...
        presets: {
            ...
            muhendis: '🏗️ Mühendis Modu',
            tam: '🎓 Tam Kapsamlı',
            arastirmaci: '🔍 Araştırmacı',
            temeller: '🧱 Temeller',
            pratik: '🛠️ Pratik Uygulama',
            hata: '🐛 Hata Ayıklama',
        ...
        previewWarning: '⚠️ Uyarı: Bu prompt URL üzerinden taşınamayacak kadar uzun (>4000 karakter). Doğrudan AI butonlarına tıkladığınızda önce panoya kopyalanacak, ardından AI sayfası boş açılacaktır. Oraya yapıştırmanız (Ctrl+V) gerekecektir.',
    ...
    en: {
        ...
        presets: {
            ...
            derin: '🔬 Deep Analysis',
            sinav: '📚 Exam Prep',
            muhendis: '🏗️ Engineer Mode',
            tam: '🎓 Full Comprehensive',
            arastirmaci: '🔍 Researcher',
            temeller: '🧱 Foundations',
            pratik: '🛠️ Practical App',
            hata: '🐛 Debugging',
        ...
        previewWarning: '⚠️ Warning: This prompt is too long to be passed via URL (>4000 chars). It will be copied to your clipboard and the AI page will open blank. You will need to paste it (Ctrl+V) there.',
